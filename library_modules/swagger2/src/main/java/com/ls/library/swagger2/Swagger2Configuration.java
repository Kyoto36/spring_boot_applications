 ...
 * Swagger2 启动类
 * 启动条件：
 * 1，配置文件中aif7.swagger.enabled=true
 * 2，配置文件中不存在：aif7.swagger.enabled 值
 *
 */
@Configuration
...
public class Swagger2Configuration implements WebMvcConfigurer {
    ...
    public static class ZhSecurityConfiguration {
        ...
        @ConditionalOnProperty(name = "aif7.swagger.production", havingValue = "true")
        ...
        @Bean
        @ConditionalOnMissingBean
        @ConditionalOnProperty(name = "aif7.swagger.basic.enable", havingValue = "true")
        ...
        @ConditionalOnMissingBean
        @ConditionalOnProperty(name = "aif7.swagger.markdown.enable", havingValue = "true")
