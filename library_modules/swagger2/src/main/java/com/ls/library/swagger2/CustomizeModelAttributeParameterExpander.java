 ...
 *
 * @see CustomizeModelAttributeParameterExpander
 * @see ModelAttributeParameterExpander
 * @see com.ls.library.swagger2.IgnoreSwaggerParameter
 */
/*
 * @Component
 * 
...
public class CustomizeModelAttributeParameterExpander extends ModelAttributeParameterExpander {
		...
		try {
			...
			for (PropertyDescriptor descriptor : descriptors) {
				...
				if (field != null) {
					...
					com.ls.library.swagger2.IgnoreSwaggerParameter ignoreSwaggerParameter = field
							.getDeclaredAnnotation(com.ls.library.swagger2.IgnoreSwaggerParameter.class);
	...
	public static String determineScalarParameterType(Set<? extends MediaType> consumes, HttpMethod method) {
		...
		if (consumes.contains(MediaType.APPLICATION_FORM_URLENCODED) && (method == HttpMethod.POST || method == HttpMethod.PUT)) {
			parameterType = "form";
		} else if (consumes.contains(MediaType.MULTIPART_FORM_DATA) && (method == HttpMethod.POST || method == HttpMethod.PUT)) {
