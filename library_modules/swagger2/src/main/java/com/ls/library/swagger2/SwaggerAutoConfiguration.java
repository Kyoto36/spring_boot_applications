...
public class SwaggerAutoConfiguration implements BeanFactoryAware {
    ...
    @Bean
    @Primary
    @ConditionalOnProperty(name = "aif7.swagger.enabled", havingValue = "true", matchIfMissing = true)
    public CustomizeModelAttributeParameterExpander expander(FieldProvider fields, AccessorsProvider accessors,
